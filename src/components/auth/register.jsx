                    ...
                    <div className="lg:w-3/5 w-full p-5">
                        ...
                        <div className="py-10">
                            ...
                            >
                                ...
                                <button onClick={handleRegister} className="bg-purple-400 hover:bg-purple-700 transition-all text-slate-100 py-2 px-5 rounded-md text-sm">
                                    Register
                                </button>
                            </div>
